    ...
    <div className="flex gap-4 p-4 bg-card rounded-lg border border-border">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-4 mt-2">
          <QuantityStepper quantity={item.quantity} onChange={(qty) => onUpdateQuantity(item.id, qty)} />
          <button onClick={() => onRemove(item.id)} className="text-destructive text-sm flex items-center gap-1 hover:underline">
